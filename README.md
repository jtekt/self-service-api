...
| **`NEXT_PUBLIC_PGRST_JWT_CERT_URL`**  | URL for the certificates.                                       | `http://keycloak/realms/realm/protocol/openid-connect/certs` |
| **`NEXT_PUBLIC_PGRST_JWT_CLAIM_KEY`** | JWT key for identifying the user.                               | `email`                                                      |
